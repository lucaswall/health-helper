...
class BloodGlucoseRecordMapperTest {
    ...
    @Test
    @DisplayName("mapToBloodGlucoseRecord maps value via BloodGlucose.millimolesPerLiter")
    fun mapsValueCorrectly() {
        val reading = GlucoseReading(valueMmolL = 5.6, timestamp = testTimestamp)
        val record = mapToBloodGlucoseRecord(reading)
        assertEquals(5.6, record.level.inMillimolesPerLiter, 0.001)
    }

    @Test
    @DisplayName("mapToBloodGlucoseRecord maps GENERAL relation to meal")
    fun mapsRelationToMealGeneral() {
        val reading = GlucoseReading(valueMmolL = 5.6, relationToMeal = RelationToMeal.GENERAL, timestamp = testTimestamp)
        val record = mapToBloodGlucoseRecord(reading)
    ...
    fun mapsRelationToMealFasting() {
        val reading = GlucoseReading(valueMmolL = 5.6, relationToMeal = RelationToMeal.FASTING, timestamp = testTimestamp)
        val record = mapToBloodGlucoseRecord(reading)
    ...
    fun mapsRelationToMealBeforeMeal() {
        val reading = GlucoseReading(valueMmolL = 5.6, relationToMeal = RelationToMeal.BEFORE_MEAL, timestamp = testTimestamp)
        val record = mapToBloodGlucoseRecord(reading)
    ...
    fun mapsRelationToMealAfterMeal() {
        val reading = GlucoseReading(valueMmolL = 5.6, relationToMeal = RelationToMeal.AFTER_MEAL, timestamp = testTimestamp)
        val record = mapToBloodGlucoseRecord(reading)
    ...
    fun mapsRelationToMealUnknown() {
        val reading = GlucoseReading(valueMmolL = 5.6, relationToMeal = RelationToMeal.UNKNOWN, timestamp = testTimestamp)
        val record = mapToBloodGlucoseRecord(reading)
    ...
    fun mapsMealTypeBreakfast() {
        val reading = GlucoseReading(valueMmolL = 5.6, glucoseMealType = GlucoseMealType.BREAKFAST, timestamp = testTimestamp)
        val record = mapToBloodGlucoseRecord(reading)
    ...
    fun mapsMealTypeLunch() {
        val reading = GlucoseReading(valueMmolL = 5.6, glucoseMealType = GlucoseMealType.LUNCH, timestamp = testTimestamp)
        val record = mapToBloodGlucoseRecord(reading)
    ...
    fun mapsMealTypeDinner() {
        val reading = GlucoseReading(valueMmolL = 5.6, glucoseMealType = GlucoseMealType.DINNER, timestamp = testTimestamp)
        val record = mapToBloodGlucoseRecord(reading)
    ...
    fun mapsMealTypeSnack() {
        val reading = GlucoseReading(valueMmolL = 5.6, glucoseMealType = GlucoseMealType.SNACK, timestamp = testTimestamp)
        val record = mapToBloodGlucoseRecord(reading)
    ...
    fun mapsMealTypeUnknown() {
        val reading = GlucoseReading(valueMmolL = 5.6, glucoseMealType = GlucoseMealType.UNKNOWN, timestamp = testTimestamp)
        val record = mapToBloodGlucoseRecord(reading)
    ...
    fun mapsSpecimenSourceCapillaryBlood() {
        val reading = GlucoseReading(valueMmolL = 5.6, specimenSource = SpecimenSource.CAPILLARY_BLOOD, timestamp = testTimestamp)
        val record = mapToBloodGlucoseRecord(reading)
    ...
    fun mapsSpecimenSourceInterstitialFluid() {
        val reading = GlucoseReading(valueMmolL = 5.6, specimenSource = SpecimenSource.INTERSTITIAL_FLUID, timestamp = testTimestamp)
        val record = mapToBloodGlucoseRecord(reading)
    ...
    fun mapsSpecimenSourcePlasma() {
        val reading = GlucoseReading(valueMmolL = 5.6, specimenSource = SpecimenSource.PLASMA, timestamp = testTimestamp)
        val record = mapToBloodGlucoseRecord(reading)
    ...
    fun mapsSpecimenSourceSerum() {
        val reading = GlucoseReading(valueMmolL = 5.6, specimenSource = SpecimenSource.SERUM, timestamp = testTimestamp)
        val record = mapToBloodGlucoseRecord(reading)
    ...
    fun mapsSpecimenSourceTears() {
        val reading = GlucoseReading(valueMmolL = 5.6, specimenSource = SpecimenSource.TEARS, timestamp = testTimestamp)
        val record = mapToBloodGlucoseRecord(reading)
    ...
    fun mapsSpecimenSourceWholeBlood() {
        val reading = GlucoseReading(valueMmolL = 5.6, specimenSource = SpecimenSource.WHOLE_BLOOD, timestamp = testTimestamp)
        val record = mapToBloodGlucoseRecord(reading)
    ...
    fun mapsSpecimenSourceUnknown() {
        val reading = GlucoseReading(valueMmolL = 5.6, specimenSource = SpecimenSource.UNKNOWN, timestamp = testTimestamp)
        val record = mapToBloodGlucoseRecord(reading)
    ...
    @Test
    @DisplayName("mapToGlucoseReading extracts value from level")
    fun reverseMapExtractsValue() {
        ...
        assertEquals(5.6, reading.valueMmolL, 0.001)
    }
